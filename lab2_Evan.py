...
print(f"The area of a circle with a radius of 2 is {area}")
...
print("\nExercise 5")
#days_of_the_week = ["sunday", "monday", "tuesday", "wendsday", "thrusday", "friday", "saturday"]
day_today = int(input("What is todays number:"))
days_trip = int(input("What is the duratiion of your trip:"))
return_day = (day_today + days_trip) % 7 
print(f"The trip starts on day {day_today}, lasts {days_trip} days, and you will return on day {return_day}")
